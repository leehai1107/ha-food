        ...
        <article className="container-limited py-12">
          <div className="max-w-4xl mx-auto">
            ...
            <header className="mb-8">
              ...
              {news.excerpt && (
                <div
                  className="bg-gray-50 border-l-4 border-primary p-6 mb-8"
                  style={{ borderRadius: "var(--border-radius)" }}
                >
            ...
            <div className="prose prose-lg max-w-none prose-headings:text-gray-900 prose-p:text-gray-700 prose-a:text-primary prose-strong:text-gray-900">
              <ReactMarkdown
                ...
                components    = {{
                  ...
                  h2: ({ children }) => (
                    <h2 className="text-2xl font-bold text-gray-900 mb-3 mt-6 font-heading">
                      {children}
                    </h2>
                  ),
                  h3: ({ children }) => (
                    <h3 className="text-xl font-bold text-gray-900 mb-2 mt-5 font-heading">
                      {children}
                    </h3>
                  ),
                  p: ({ children }) => (
                    <p className="text-gray-700 mb-4 leading-relaxed font-primary">
                      {children}
                    </p>
                  ),
                  ul: ({ children }) => (
                    <ul className="list-disc list-inside mb-4 text-gray-700 font-primary">
                      {children}
                    </ul>
                  ),
                  ol: ({ children }) => (
                    <ol className="list-decimal list-inside mb-4 text-gray-700 font-primary">
                      {children}
                    </ol>
                  ),
                  li: ({ children }) => (
                  ...
                  a: ({ href, children }) => (
                    <a
                      href={href}
                      className="text-primary hover:text-secondary underline font-primary"
                    >
                      {children}
                    </a>
                  ),
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <div className="flex space-x-4">
                    <button
                      className="flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors font-primary"
                      style={{ borderRadius: "var(--border-radius)" }}
                    >
                      <svg
                    ...
                    <button
                      className="flex items-center px-4 py-2 bg-blue-800 text-white rounded-lg hover:bg-blue-900 transition-colors font-primary"
                      style={{ borderRadius: "var(--border-radius)" }}
                    >
                      <svg
                        className="w-4 h-4 mr-2"
